...
\begin{figure}[!h]
	...
	\label{garchS}
\end{figure}
All the graphs (Fig 4.22 to Fig 4.24) clearly display presence of VaR violations. The Garch (1,1) model seems to overreact when at the very extreme. When there is a very large loss, then there is a downward movement of the VaR-estimators by the Garch model and they recover quickly. Hence, it is not as stable as the historical simulation as it seems to forget what has happened in the past.\\\\
\textbf{LSTM}	
\begin{figure}[!h]
	\centering
