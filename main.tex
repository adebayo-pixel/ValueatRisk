...
\begin{document}
	...
	I would like to express my profound gratitude to my supervisor Prof. Dr. Ralf Korn for his untiring support and guidance in the course of writing this thesis.\newline
	
	I thank family for their emotional support and encouragement. I appreciate my friends, Ajay Chawda and Mahboob Zakariyau for their technical support.
	\end{titlepage}
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
For our daily VaR estimation, we use the conditional variance given by GARCH(1,1) model. We assume the random error to have a standardized student’s t-distribution with 4 degrees of freedom. Our Value at Risk is given by:
\begin{center}
...
\begin{table}[h]
	...
	\begin{tabular}{|*{5}{c|}}
		...
		\hline
		NN model  & (0.040) 56  & (0.023) 32  & 2.87 (acc)   &17.51 (rej)  \\
		\hline
	\end{tabular}
\end{table}
...
\begin{figure}[!h]
	...
	\caption{Daily VaR estimation of NIKKEI 225}
	\label{HistN}
\end{figure}
...
\begin{figure}[!h]
	...
	\caption{Daily VaR estimation of FTSE 100}
	\label{HistF}
\end{figure}
